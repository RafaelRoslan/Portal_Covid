        ...
        <div class="card corcard">
          ...
          <div class="card-body">
            <h5 class="card-title">USO DA MÁSCARA</h5>
                    <button class="accordion-button testeremover" type="button" data-bs-toggle="collapse" data-bs-target="#teste0" aria-expanded="true" aria-controls="collapseOne">
                      Veja aqui
                    </button>
            
            <section class="accordion-body accordion-collapse collapse corcard2" aria-labelledby="headingOne" id="teste0" >
    ...
    <div class="col">
        <div class="card corcard">
          ...
          <div class="card-body">
            ...
            <section class="accordion-body accordion-collapse collapse corcard2" aria-labelledby="headingOne" id="teste1" >
    ...
    <div class="col">
        <div class="card corcard">
          ...
          <div class="card-body">
            ...
            <section class="accordion-body accordion-collapse collapse corcard2" aria-labelledby="headingOne" id="teste2" >
    ...
    <div class="col">
        <div class="card corcard">
          ...
          <div class="card-body">
            ...
            <section class="accordion-body accordion-collapse collapse corcard2" aria-labelledby="headingOne" id="teste4" >
    ...
    <div class="col">
          <div class="card corcard">
            ...
            <div class="card-body">
              ...
              <section class="accordion-body accordion-collapse collapse corcard2" aria-labelledby="headingOne" id="teste3" >
