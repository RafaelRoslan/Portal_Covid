...
<main class="container text-justify ">
    <div class="row py-4 justify-content-evenly ">
        ...
        <article class="col-10 col-sm-12 col-md-12 col-lg-8 mt-4">
            <h2>Variante Gama</h2>
            <p> <b>Quem é:</b> Trata-se da variante descoberta no fim do ano passado em japoneses que voltavam do
                Amazonas.</p>
            ...
            <p> <b>Comportamento:</b> Mais transmissível, tanto que devastou o país entre março e abril e ainda está
                ...
                mistério. Dados até apontam que ela pode, sim, ser mais letal e
                aumentar o risco de internação, mas não dá para saber se é culpa da variante ou de outros fatores.</p>
            <p> “Tivemos 70% dos óbitos da pandemia no país nos últimos meses, com a predominância da Gama, mas
            ...
            <div class="row justify-content-around align-items-center">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p> <b>Situação epidemiológica:</b> Calcula-se que seja responsável por nove em cada dez casos de
                        ...
                        que ainda não tivemos uma grande penetração das variantes importadas.</p>
                </div>
                <section class="col-10 col-sm-12 col-md-12 col-lg-4">
                    <img class="imglargura py-2" src="imagens/corona vermelho.png"
                        alt="Imagem que ilustra uma versão cartunizada de um virus, na cor vermelha">
                </section>
            </div>
        </article>
    </div>>
