...
<?php include_once('includes/var_nav.php'); ?>
    <article class="col-6 offset-1">
      <h1> Entenda como surgem as variantes dos vírus e por que, na pandemia de Covid, a Delta preocupa. </h1>
        ...
        <p> Mas como surge uma nova variante? Com poucos casos, é pequena a chance de uma surgir. Mas não é o caso da Índia ou do Brasil, por exemplo, onde surgem cerca de 70 mil casos novos todo dia.</p>
        <p> "Como é um processo ao acaso, se você não tem um controle adequado, se você não vacina na quantidade adequada, aí é que você permite, sim, que a variante surja e ela se dissemine, e que talvez ela se torna um problema no futuro", explica Spilki.</p>
    ...
    <aside class="col-3 offset-1">
      ...
      <p> O Instituto Butantan detectou 36 variantes do coronavírus em circulação no Estado de São Paulo, sendo que três delas foram identificadas pela primeira vez. O Boletim Epidemiológico da Rede de Alerta das Variantes também identificou quatro novas linhagens da variante Delta. Apesar do número crescente de variantes, casos de Covid-19 diminuíram em São Paulo.</p>
      <p> As informações foram apresentadas pela diretora do Centro de Desenvolvimento Científico do Butantan, Sandra Vessoni, em evento realizado nesta segunda-feira (30/8) pelo ILP (Instituto do Legislativo Paulista) em parceria com a Fapesp (Fundação de Amparo à Pesquisa no Estado de São Paulo).</p>
      <p> Entre as variantes identificadas de forma inédita, estão a B.1.1621.1, também conhecida como Copa América; a B.1.540; e a AY.3; com um, cinco e três casos, respectivamente, de acordo com dados da 32° semana epidemiológica, sequenciados até o último dia 14.</p>
