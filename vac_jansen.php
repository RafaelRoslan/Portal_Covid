...
<main class="container text-justify">
      <div class="row justify-content-evenly">
            <section class="col-8 col-sm-9 col-md-8 col-lg-9 offset-4">
                  <img class="ser" src="imagens/jansen.jpg" alt="Ampola de vacina com seringa a frente do simbolo da Johnson e Johnson">
            </section>
      ...
      <div class="row justify-content-evenly">
            <article class="col-10 col-sm-8 col-md-5 col-lg-5">
            ...
            <h4>Janssen</h4>
                ...
                <p>Quando falamos na seguraça de uma vacina, o objetivo é garantir que a vacina não traga riscos à saúde. Por isso, a segurança da vacina é avaliada durante toda a fase clínica do estudo, principalmente em sua primeira fase, onde o número de participantes é reduzido.</p><p>A eficácia da vacina indica a capacidade do imunizante em conferir proteção imunológica a um determinado agente, no caso, o vírus SARS-CoV-2. O termo é utilizado quando falamos da fase 3 dos ensaios clínicos, ou seja, para fazer referência ao percentual de pessoas vacinadas, nas condições controladas do estudo, que adquiriram imunidade ao vírus.</p>
                
            </article>
            <aside class="col-10 col-sm-8 col-md-5 col-lg-5">
                ...
                <p>Recortes retirados de: <a class="recort" href="https://coronavirus.saude.mg.gov.br/blog/331-vacinacao-covid-19-janssen">Coronavirus MG</a></p>
