...
<div class="container">
  ...
  <div class="col-10 col-sm-12 col-md-10 col-lg-11">
      ...
      <p class="fontteste">A pandemia do coronavírus assumiu no Brasil a dimensão de uma catástrofe humanitária. Centenas de milhares de pessoas perderam a vida, outras tantas apresentam as sequelas de uma lenta recuperação, e milhões foram levados ao desemprego e à faixa da pobreza extrema. </p>        
...
<div class="row py-4 px-5 align-items-center justify-content-center corcard">
    <article class="col-10 col-sm-12 col-md-12 col-lg-5 mx-4">
    ...
    <aside class="col-10 col-sm-10 col-md-10 col-lg-3 mx-4">
      <img src="imagens/comercio" class="img-fluid" alt="ilustração que representa o corona virus como o planeta terra.">
    </aside>
</div>
 <!--fim container2-->
 <!--container3-->
...
<div class="row mb-3 py-4 align-items-center justify-content-center">
    <aside class="col-10 col-sm-10 col-md-10 col-lg-4">
        <img src="imagens/trabalho" class="img-fluid" alt="graficos de casos registrados na Itália, desde a abril de 2020 até novembro de 2021.">
    </aside>

    <article class="col-10 col-sm-12 col-md-12 col-lg-7">
