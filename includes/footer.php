  ...
  <div class="row offset-1 sublinhado centralizar">
    <section class="col-10 col-sm-12 col-md-12 col-lg-3 text-justify ">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Consequências</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Variantes</a></li>
        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Prevenção</a></li>
