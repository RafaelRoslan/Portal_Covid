...
<main class="container text-justify ">
  <div class="row py-4 justify-content-evenly ">
    ...
    <article class="col-10 col-sm-12 col-md-12 col-lg-8 mt-4">
      ...
      <div class="row justify-content-around align-items-center">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-7">
          ...
          <p> <b> Mutações:</b> São 22 ao todo, entre as que alteram ou não a estrutura do vírus. As principais estão na
            espícula, a proteína que recobre o vírus. Uma das mais famosas é a mutação N501Y, que intensifica a ligação
            entre o vírus e as células humanas.</p>
      ...
      <p> <b>Situação epidemiológica:</b> Ela foi a responsável pela segunda onda da pandemia que atacou os países do
