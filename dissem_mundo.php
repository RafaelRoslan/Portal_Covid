  ...
  <article class="row py-4 justify-content-evenly ">
    <section class="col-10 col-sm-10 col-md-10 col-lg-10">
      ...
      <p>Depois do vírus ter sido identificado, diversos casos foram sendo detectados em outros países até chegar em
        ...
        meses de pandemia. Países asiáticos como Japão e Coreia do Sul acabaram por adotar as medidas de prevenção com
        maior antecedência, o que permitiu um maior controle da disseminação do vírus. </p>
      <p>Após o vírus ter sido detectado em Wuhan, alguns países se tornaram o epicentro da pandemia da Covid-19 por
        conta do aumento repentino de casos. Em março de 2020, a Itália era considerada o epicentro da doença fora do
    ...
    <div class="col-10 col-sm-10 col-md-10 col-lg-10 ">
      ...
      <section class="col-12 col-sm-12 col-md-12 col-lg-5 bg-dark bg-opacity-25 rounded-3 p-3 order-lg-1 mt-5 mt-lg-3">
          ...
          <p>Em março de 2020, a Itália era o segundo país com o maior número de casos, ficando somente atrás da China.
            Entre os dias 9 e 11 de março de 2020, o governo italiano começou a decretar medidas de distanciamento
            social
            para limitar a disseminação do vírus.</p>
          <p>No mesmo mês, o Primeiro-ministro italiano Giuseppe Conte anunciou novas medidas restritivas como o
            fechamento de todas as fábricas e indústrias que não fossem absolutamente essenciais, chamando a crise de
            saúde pública como a maior crise que o país enfrentou desde a Segunda Guerra Mundial.</p>
          <p>Durante a primeira onda de casos na Itália, que ocorreu em pouquíssimas semanas, o sistema de saúde
            colapsou.
            A situação na Itália acabou por alertar os líderes dos países europeus sobre a gravidade do novo coronavírus
            e
            o quão importante são as medidas de prevenção. Assim, outros países foram adotando medidas preventivas, como
            restrições de viagens e de circulação, de modo a achatar a curva e impedir que os seus sistemas de saúde
            também ficassem sobrecarregados.</p>
      ...
      <div class="row mb-3 justify-content-evenly align-items-center">
        <section class="col-12 col-sm-12 col-md-12 col-lg-5 mt-5 mt-lg-3">
          ...
          <p>O primeiro caso de Covid-19 foi registrado nos EUA em 21 de janeiro de 2020. No início de fevereiro do
            mesmo
            ano, a administração Trump declarou a Covid-19 como uma emergência de saúde pública e, em março de 2020, a
            disseminação do novo coronavírus foi anunciada como uma emergência nacional. Assim, também foi
            disponibilizado
            um orçamento federal de USD$ 50 bilhões para o combate à disseminação da doença.</p>
          <p>Os casos foram aumentando e, em 28 de maio de 2020, as mortes causadas pelo Sars-CoV-2 ultrapassam a marca
            de
        ...
        <aside class="col-12 col-sm-12 col-md-10 col-lg-7">
          <img src="imagens/grafico_eua.png" class="imglargura px-2"
            alt="graficos de casos registrados nos Estados Unidos, desde a abril de 2020 até novembro de 2021.">
        </aside>
    ...
    <article class="col-10 col-sm-10 col-md-10 col-lg-10 bg-dark bg-opacity-25 rounded-3 p-3">
      ...
      <p>O país teve uma resposta imediata após a identificação dos casos de Covid-19: Wuhan passou por um lockdown de
        76 dias, que começou em 23 de janeiro de 2020. Assim, a circulação de pessoas entre uma região e outra dentro do
        país foi limitada, além disso diversas cidades implementaram restrições nas quais apenas um dos membros da
        família tinha a permissão de sair para obter os bens essenciais durante o período de isolamento social. </p>
      <p>Em semanas, o governo chinês conseguiu testar cerca de 9 milhões de pessoas em Wuhan. Outro fator que ajudou o
        combate à transmissão do novo coronavírus foi a aderência da população chinesa ao uso de máscaras. Por exemplo,
        enquanto ainda em meados de junho e julho de 2020 muitas pessoas nos Estados Unidos recusavam-se a usar
        máscaras, a população chinesa aderiu à prática rapidamente já por experiências passados, como o surto causado
        por outro coronavírus, o Sars-CoV, em 2002 na Ásia. </p>
      <p>No dia 7 de maio de 2021, a China contabilizava 102.589 casos de Covid-19 e foram registradas 4.846 mortes pela
